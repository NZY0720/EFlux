...
export interface components {
  schemas: {
    ...
    BehaviorDatasetCreateIn: { name : string; version : string; description?: string; market : "realprice" | "p2p" | "hybrid"; visibility?: "public" | "private"; schema_version?: string; manifest?: { [key: string]: unknown; }; artifact_path?: string | null; row_count?: number; license?: string; parent_dataset_id?: number | null; source_release_id?: number | null; };
