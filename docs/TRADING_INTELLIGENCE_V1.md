# Trading Intelligence & Market Mechanism V1

This document is the implementation index for the current V1 design. V1 is the
only supported project contract. Pre-reset checkpoints, payloads and generated
results are intentionally unsupported.

The current verification record is
[TRADING_V1_ACCEPTANCE.md](TRADING_V1_ACCEPTANCE.md).
...
tests is not sufficient when the legacy behavior conflicts with V1 economics.
